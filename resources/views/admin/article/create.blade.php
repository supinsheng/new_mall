    ...
    <div>
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/article/insert" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    @csrf
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                <th>跳转的地址：</th>
                                <td><input class="common-text" name="link" size="50"  type="text" placeholder="若不需要跳转，可以不填"></td>
                            </tr>
