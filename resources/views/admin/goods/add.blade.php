                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="home">
                                <div class="row data-type">                                  
								   ...
								   <div class="col-md-2 title editer">LOGO</div>
		                           <div class="col-md-10 data editer">
		                               <input type="file" class="form-control preview">
		                           </div>
		                           
		                           <div class="col-md-2 title">是否上架</div>
		                           <div class="col-md-10 data">
		                           	   <div class="input-group">
											<input type="radio" name="is_show" checked id="">上架	&nbsp;&nbsp;&nbsp;&nbsp;		                               
											<input type="radio" name="is_show" id="">下架			                               
		                           	   </div>
		                           </div>
		                           
		                           <div class="col-md-2 title editer">商品描述</div>
                                   <div class="col-md-10 data editer" id="content"></div>                                   
                                </div>
                            </div>
