		...
		<div class="py-container">
			<div class="yui3-g SortList ">
				<div class="yui3-u Left all-sort-list">
					...
					@foreach($data as $v)
						<div class="item">
							<h3><a href="/home/search?id={{ $v->id }}">{{ $v->cat_name }}</a></h3>
							<div class="item-list clearfix">
								<div class="subitem">
								@foreach($v['subMenuLevel1'] as $v1)
									<dl class="fore1">
										<dt><a href="/home/search?id={{ $v1->id }}">{{ $v1->cat_name }}</a></dt>
										<dd>
											@foreach($v1['subMenuLevel2'] as $v2)
											<em><a href="/home/search?id={{ $v2->id }}">{{ $v2->cat_name }}</a></em>
											@endforeach
										</dd>
									</dl>
								@endforeach
